        ...
        try {
            ...
            if (result.success) {
                if (result.user.role !== 'superadmin') {
                    setErrorLine('Access denied. This login is for Superadmins only.');
                    setIsLoading(false);
                    return;
                }
                ...
                setErrorLine(result.message || 'Invalid email or password.');
            }
        } catch (error) {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                width: '100%',
                maxWidth: '420px',
                boxShadow: '0 25px 50px -12px rgba(255, 122, 0, 0.2)'
            }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2.5rem' }}>
                    <div style={{
                        ...
                        <ShieldCheck size={36} color="#ff5a1f" />
                    </div>
                    <h1 style={{ color: '#1a1e26', fontSize: '1.75rem', fontWeight: 700, margin: '0 0 0.5rem 0' }}>Super Admin</h1>
                    <p style={{ color: '#64748b', margin: 0, fontSize: '0.95rem' }}>Central Management Access</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        ...
                        onMouseOver={(e) => !isLoading && (e.currentTarget.style.background = '#e54e1a')}
                        onMouseOut={(e) => !isLoading && (e.currentTarget.style.background = '#ff5a1f')}
